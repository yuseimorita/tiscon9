...
public class EstimateController {
    ...
    String calculation(@Validated UserOrderForm userOrderForm, BindingResult result, Model model) {
        ...
        PriceDto pricedto = estimateService.getPrice(dto);

        model.addAttribute("prefectures", estimateDAO.getAllPrefectures());
        model.addAttribute("userOrderForm", userOrderForm);
        model.addAttribute("total", pricedto.getTotal());
        model.addAttribute("priceForDistance", pricedto.getPriceForDistance());
        model.addAttribute("pricePerTruck", pricedto.getPricePerTruck());
        model.addAttribute("multiplier", pricedto.getMultiplier());
        model.addAttribute("priceForOptionalService", pricedto.getPriceForOptionalService());
        return "result";
    }
